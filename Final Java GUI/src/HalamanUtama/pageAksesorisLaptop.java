...
public class pageAksesorisLaptop extends javax.swing.JFrame {
    
    menuTes menuT = new menuTes();
    AksesorisLaptop aksTes = new AksesorisLaptop();

    public pageAksesorisLaptop() throws SQLDataException {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pageAksesorisLaptop.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new pageAksesorisLaptop().setVisible(true);
                } catch (SQLDataException ex) {
                    Logger.getLogger(pageAksesorisLaptop.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
