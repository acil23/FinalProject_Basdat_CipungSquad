...
public class pageLaporan extends javax.swing.JFrame {
    ...
    public pageLaporan() throws SQLDataException {
        initComponents();
        setBackground(new Color(0, 0, 0, 0));
        border1.add(menuT, BorderLayout.WEST);
        border1.add(lap, BorderLayout.CENTER);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pageLaporan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new pageLaporan().setVisible(true);
