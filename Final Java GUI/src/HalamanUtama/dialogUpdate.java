...
public class dialogUpdate extends javax.swing.JDialog {
    ...
    public dialogUpdate(java.awt.Frame parent, boolean modal) throws SQLException {
        super(parent, modal);
        initComponents();
        ...
        upd = new updateBarang();
        border21.add(upd, BorderLayout.CENTER);
    ...
    private void initComponents() {
        ...
        panelGerak.setText("Update Barang");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialogUpdate dialog = null;
                try {
                    dialog = new dialogUpdate(new javax.swing.JFrame(), true);
