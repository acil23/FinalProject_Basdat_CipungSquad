...
public class pageSemuaAksesoris extends javax.swing.JFrame {
    
    menuTes menuT = new menuTes();
    SemuaAksesoris aksTes = new SemuaAksesoris();
    

    public pageSemuaAksesoris() throws SQLDataException {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pageSemuaAksesoris.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new pageSemuaAksesoris().setVisible(true);
                } catch (SQLDataException ex) {
                    Logger.getLogger(pageSemuaAksesoris.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
