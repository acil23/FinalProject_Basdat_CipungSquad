...
public class pageAksesorisLainnya extends javax.swing.JFrame {
    
    menuTes menuT = new menuTes();
    AksesorisLain aksTes = new AksesorisLain();

    public pageAksesorisLainnya() throws SQLDataException {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pageAksesorisLainnya.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new pageAksesorisLainnya().setVisible(true);
                } catch (SQLDataException ex) {
                    Logger.getLogger(pageAksesorisLainnya.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
